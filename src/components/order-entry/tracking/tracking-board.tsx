                ...
                <Table className="border-collapse">
                  <THead>
                    <tr>
                      ...
                      <Th className="sticky left-0 z-30 border-r-0 bg-surface px-4 after:pointer-events-none after:absolute after:inset-y-0 after:right-0 after:w-px after:bg-border-strong after:content-['']">
                        Quality
                      </Th>
                      <Th>Design</Th>
  ...
  return (
    <tr className="border-b border-border align-top last:border-0">
      {/* The sticky column's right rule is a SHADOW, not a border: a border
          ...
          under it. */}
      <td className="sticky left-0 z-10 bg-surface px-4 py-3 after:pointer-events-none after:absolute after:inset-y-0 after:right-0 after:w-px after:bg-border-strong after:content-['']">
