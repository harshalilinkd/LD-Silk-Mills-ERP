...
import { firstZodError, stageUpdateSchema } from "@/lib/order-entry/validation";
...
// PATCH /api/order-entry/stages/:stage_key — edit a stage's
// planned_offset_days (ADMIN). Applies to NEW orders (and to open orders if
// the recompute action is run).
