...
// GET /api/order-entry/design-database?search=&fabric=&page= — browsable
// design log (ADMIN), newest first. NOTE: distinct from
// /api/order-entry/designs, which is the autocomplete-only endpoint used by
// the order form.
