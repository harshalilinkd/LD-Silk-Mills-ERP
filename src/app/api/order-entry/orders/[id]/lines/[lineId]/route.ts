...
// DELETE /api/order-entry/orders/:id/lines/:lineId — permanently remove ONE
// design line (cascade drops its stage progress). Used from Trash to purge a
// soft-deleted design for good. Only a line that is already soft-deleted can be
// purged here (guards against wiping an active design). orders.edit only.
