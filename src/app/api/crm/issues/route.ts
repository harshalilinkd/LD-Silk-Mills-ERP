...
import { loadCrmConfig, loadIssues } from "@/lib/order-entry/crm-query";
import { shouldEscalate } from "@/lib/order-entry/crm";
import { issueCreateSchema, firstZodError } from "@/lib/order-entry/validation";
import {
  crmFollowups,
  crmIssues,
  lookupValues,
