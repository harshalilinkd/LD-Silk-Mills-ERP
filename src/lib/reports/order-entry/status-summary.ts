...
export const statusSummary: ReportDefinition = {
  ...
  columns: [
    ...
    { key: "lines_pct", label: "Lines through", type: "percent", total: "avg", note: "How much of this order has finished. The foot shows the figure across the whole file." },
    ...
    { key: "days_since_move", label: "Days since move", type: "number", total: "avg", note: "Since the last stage was ticked. Averaged at the foot." },
