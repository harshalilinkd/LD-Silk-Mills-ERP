...
export const customerLedger: ReportDefinition = {
  ...
  columns: [
    ...
    { key: "avg_rate", label: "Avg rate", type: "money", note: "Value divided by metres." },
    ...
    { key: "agents", label: "Agents", type: "int", note: "How many different agents have handled this customer." },
    ...
    { key: "days_since_last", label: "Days quiet", type: "int", note: "From their last order to today." },
